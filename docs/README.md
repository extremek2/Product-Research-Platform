...
| 문서 | 상태 |
|---|---|
| [ADR-0001: Core와 Automation 소유권 분리](architecture/ADR-0001-p0-service-and-data-ownership.md) | 승인 제안, 검토 중 |
| [P0 실행 계획](architecture/P0_EXECUTION_PLAN.md) | ADR 승인 후 실행할 초안 |
...
- 적용된 Flyway 파일은 수정하지 않는다. 새 마이그레이션 번호는 작업 직전에 디렉터리의 최신 번호를 확인한다.
