...
export const companies = () => apiRequest('/organizations/current/partners');
export const createCompany = data => apiRequest('/organizations/current/partners', { method: 'POST', body: JSON.stringify(data) });
export const partners = shipmentId => apiRequest(`/shipments/${shipmentId}/partners`);
export const attachCompany = (shipmentId, companyId) => apiRequest(`/shipments/${shipmentId}/partners`, { method: 'POST', body: JSON.stringify({ companyId }) });
