...
const API = process.env.REACT_APP_AI_API_URL || "http://localhost:8000/api/v1";
const SPRING = process.env.REACT_APP_API_URL || "http://localhost:8080/api/v1";
...
function Products({ initialKeyword = "" }) {
  ...
  // This legacy page intentionally loads once; searches run through handleSearch.
...
// ─── App ─────────────────────────────────────────────────────────
export default function ResearchPage({ onExit }) {
