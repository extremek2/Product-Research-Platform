...
public class AuthController {
    ...
    private final com.productresearch.apiserver.domain.collaboration.CollaborationService collaboration;
    private final com.productresearch.apiserver.domain.onboarding.service.VerificationRateLimiter rateLimiter;
    ...
    public ApiResponse<Void> caseLink(@Valid @RequestBody com.productresearch.apiserver.domain.collaboration.CollaborationRequests.RequestLink request, jakarta.servlet.http.HttpServletRequest http) {
        caseRateLimit(http);
    ...
    public ResponseEntity<ApiResponse<AuthResponse>> confirmCase(@Valid @RequestBody com.productresearch.apiserver.domain.collaboration.CollaborationRequests.Confirm request, jakarta.servlet.http.HttpServletRequest http) {
        caseRateLimit(http);
