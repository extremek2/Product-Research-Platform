package com.productresearch.apiserver.domain.identity;
...
import static com.productresearch.apiserver.domain.identity.entity.OrganizationMember.Role.*;
...
class OrganizationMemberIntegrationTest extends PostgresTestSupport {
    ...
    com.productresearch.apiserver.domain.platform.repository.IdentityAuditRepository audit;
